...
//  Gotogo
//
//  BIP-0039 English wordlist (2048 words) for the 24-word recovery phrase.
//  Generated asset — do not edit by hand. Source: bitcoin/bips bip-0039/english.txt
//

import Foundation

/// The 2048-word BIP-39 English list, indexed 0...2047.
enum BIP39WordList {
    static let words: [String] = rawList
        .split(separator: " ")
        .map(String.init)

    private static let rawList: String =
